...
const InnerSmallHero = (p) => <AsOrSpan {...p} />;
...
export const H2 = ({children, ...rest}) => (
  <h2 style={{marginBottom: "2rem"}} {...rest}>
    <Border>
...
export const Link = (p) => <ExternalOrInternalLink {...p} />;
